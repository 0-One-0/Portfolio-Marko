export default function CVInfo({
  ...
  return (
    <>
      <div className="flex flex-col gap-3 border  border-amber-200/20 shadow-[0_0_15px_rgba(251,191,36,0.15)] dot-grid rounded-sm border-box w-full max-w-150 items-start p-4">
        ...
        <div className="w-70 h-0.5 bg-black rounded self-center"></div>
